...
def get_args_parser():
    ...
    # Add after the evaluation parameters section
    parser.add_argument('--enable_gradcam', type=str2bool, default=False,
                        help='Enable Grad-CAM++ visualization during evaluation')
    parser.add_argument('--gradcam_layer', type=str, default='pfe_high',
                        choices=['pfe_high', 'pfe_low', 'sfe'],
                        help='Target layer for Grad-CAM++')
    parser.add_argument('--gradcam_save_dir', type=str, default=None,
