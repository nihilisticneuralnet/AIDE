        ...
        for v_id, val in enumerate(vals):
            ...
            if args.generate_cams:
                ...
                generate_cams_for_dataset(
                    model=model_without_ddp if args.distributed else model,
                    dataloader=data_loader_val,
                    device=device,
                    output_dir=cam_out_dir,
                    branches=args.cam_branches,
                    save_raw=args.cam_save_raw,
                    save_overlay=args.cam_save_overlay,
                    save_fused=True
                )
                print(f"CAM visualizations saved to {cam_out_dir}")
